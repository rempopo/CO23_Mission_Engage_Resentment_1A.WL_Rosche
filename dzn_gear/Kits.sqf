...
#define SOV_HEAD ["CUP_H_RUS_SSH68_cover_berezka","rhs_beanie_green","CUP_H_RUS_SSH68_olive","rhs_fieldcap_khk"]
...
kit_sov_sl = [
	...
	["<BACKPACK ITEMS >> ",[["CUP_1Rnd_HE_GP25_M",10],["CUP_1Rnd_SmokeRed_GP25_M",3],["CUP_1Rnd_SMOKE_GP25_M",3]]]
];
kit_sov_ar = [
	["<EQUIPEMENT >>  ",SOV_UNI,"rhs_6b5_khaki","rhs_sidor",SOV_HEAD,""],
	["<PRIMARY WEAPON >>  ","CUP_arifle_RPK74","CUP_40Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M",["CUP_muzzle_Bizon","",NIGHT_SCOPE,""]],
...
kit_sov_ss = [
	...
	["<PRIMARY WEAPON >>  ","CUP_arifle_AKM","CUP_30Rnd_762x39_AK47_bakelite_M",["CUP_muzzle_Bizon","","CUP_optic_PSO_1_AK_open",""]],
	["<LAUNCHER WEAPON >>  ","rhs_weap_rshg2","rhs_rshg2_mag",["","","",""]],
	["<HANDGUN WEAPON >>  ","","",["","","",""]],
	["<ASSIGNED ITEMS >>  ", ASSIGNED_ITEMS_L],
	["<UNIFORM ITEMS >> ",[UNIFORM_ITEMS_L]],
	["<VEST ITEMS >> ",[["rhs_mag_rgd5",3],["PRIMARY MAG",5]]],
	["<BACKPACK ITEMS >> ",[["DemoCharge_Remote_Mag",2],["ACE_Clacker",1],["ACE_wirecutter",1],[NIGHT_SCOPE,1]]]
];
kit_sov_gr = [
	["<EQUIPEMENT >>  ",SOV_UNI,"rhs_6b5_rifleman_khaki","RD_54_69",SOV_HEAD,""],
	["<PRIMARY WEAPON >>  ","CUP_arifle_AKM_GL","CUP_30Rnd_762x39_AK47_bakelite_M",["CUP_muzzle_Bizon","",NIGHT_SCOPE,""]],
...
kit_sov_cargo = [
	...
	[["CUP_30Rnd_762x39_AK47_bakelite_M",20],["rhs_mag_rgd5",10],["CUP_1Rnd_HE_GP25_M",15],["CUP_40Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M",10],["DemoCharge_Remote_Mag",2],["rhs_mag_nspn_green",5],["rhs_mag_rdg2_white",5],["CUP_30Rnd_TE1_Green_Tracer_762x39_AK47_bakelite_M",5],["CUP_1Rnd_SMOKE_GP25_M",6],["CUP_1Rnd_SmokeRed_GP25_M",6],["CUP_10Rnd_762x54_SVD_M",20],["rhs_mag_9x18_8_57N181S",10]],
	[["FirstAidKit",8],["ACE_wirecutter",2],["ACE_Clacker",1], ["ACE_DefusalKit",2]],
	[]
];
kit_us_random = [
	"kit_us_r"
