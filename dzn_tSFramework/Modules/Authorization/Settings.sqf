...
GVAR(RuleList) = [
	...
	ROLE "210 Командир взвода"			HAS [ALL_ALLOWED] PERMISSIONS,
	...
	ROLE "211 Командир отделения"	HAS [ARTILLERY_ALLOWED, AIRBORNE_ALLOWED, POM_NO] PERMISSIONS,
	ROLE "212 Командир отделения"	HAS [ARTILLERY_ALLOWED, AIRBORNE_ALLOWED, POM_NO] PERMISSIONS,
	ROLE "213 Командир отделения"	HAS [ARTILLERY_ALLOWED, AIRBORNE_ALLOWED, POM_NO] PERMISSIONS
];
